            ...
            <div class="col-lg-4 text-center">
                ...
                <div class="mt-1">
                    <button type="button" id="edit-profile" class="btn btn-link edit-icon" style="display: block; margin: 0 auto; text-decoration: underline;">
                        <i class="fas fa-pencil-alt" style="margin-right: 5px;"></i> Edit Profil
                    </button>
                </div>
            </div>
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    initialValues.fullName = fullName.value;
                    initialValues.username = username.value;
                    initialValues.email = email.value;
                    initialValues.phone = phone.value;
                    initialValues.dob = dob.value;
                    initialValues.address = address.value;
