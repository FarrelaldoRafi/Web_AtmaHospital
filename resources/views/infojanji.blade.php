...
<main>
    ...
    <div class="container">
        ...
        <div class="card-centered mx-auto d-flex flex-row p-2 my-5 col-md-10" style="background-color: #EFEFEF; border-radius: 20px;">
            <div class="card border border-black col-md-3 m-3">
                <img src="https://cdn.prod.website-files.com/62d4f06f9c1357a606c3b7ef/65ddf3cdf19abaf5688af2f8_shutterstock_1933145801%20(1).jpg" alt="d1" style="object-fit:cover; height: 300px;;">
                <div class="card-body bg-body-secondary border border-black border-start-0 border-end-0 text-center">
                    <h6 class="object-fit-cover fw-bold">dr. Narji Sandoro, Sp.PD.</h6>
                </div>
                <div class="card-footer bg-body-secondary border border-black border-start-0 border-end-0 border-top-0 text-center">
                    <h6 class="object-fit-cover fw-bold">Penyakit Dalam</h6>
                </div>
            </div>            
                ...
                <div class="card bg-body-secondary mx-auto p-1 col-md-12 mt-4 d-flex flex-row p-2" style="height: 60%;">
                    <div class="col-md-10">
                        ...
                        <div class="d-flex flex-row">
                            <div class="me-auto col-md-5 d-flex flex-column mt-4">
...
<!-- Kubingung ini harusnya apa? dropdown?                                 -->
                    ...
                    <div class="col-md-2 justify-content-center align-items-center text-center">
                        <div class="container bg-white col-md-6 m-0 col-md-6 mx-auto rounded border border-black">
