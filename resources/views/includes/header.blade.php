...
<!-- SEMENTARA                         -->
            ...
            <a href="{{ url('login') }}" class="btn btn-yellow d-lg-none ms-lg-3 me-5 order-lg-1 order-2" style="border-radius: 20px; background-color: #FFD700; color: #004080; width: 150px; height: 11.1vh;" id="loginButton">
                Login
            </a>
        </div>
    </div>
