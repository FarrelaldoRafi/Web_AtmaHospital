                    ...
                    <ul class="footer-list icon-list">
                        <li>
                            <a href="tel:1-500-805" target="_blank">
                                ...
                                <div class="text">Ambulans &amp; Gawat Darurat 1-234-567</div>
                            </a>
                        </li>
                        <li>
                            <a href="tel:(0274) 446 3535" target="_blank">
                                ...
                                <div class="text">Pusat Panggilan (0123) 456 7890</div>
                            </a>
                        </li>
                        <li class="d-lg-block d-none">
                            <a href="https://api.whatsapp.com/send?phone=628112683535" target="_blank">
                                ...
                                <div class="text">Whatsapp 6281234567890</div>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:info@atma-hos.co.id" target="_blank">
                                ...
                                <div class="text">info@atma-hos.co.id</div>
                            </a>
                        </li>
                    </ul>
                </div>
